...
const Newsletter = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      toast({
        title: "Thank you for subscribing to Stacktio!",
        description: "You'll receive Stacktio news and insights soon."
      });
      setEmail("");
      ...
      <div className="section-container opacity-0 animate-on-scroll">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-xl text-gray-700 mb-10 text-left">
            Be first to get Stacktio news, insights, and deployment opportunities
          </p>
